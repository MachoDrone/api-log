...
if ! grep -qi Microsoft /proc/version && ! grep -qi WSL /proc/version; then echo -e "\033[31mTHIS SCRIPT IS MEANT FOR WINDOWS WSL2, NOT NATIVE UBUNTU LINUX.. use the correct script for your OS\033[0m" | tee -a api-logs.txt; fi
cat api-logs.txt
